...
Here, I list some of those activities, for possible commendation or derision, or at the first least as a way for you
...
## Current Project
 ...
 a real-time charts on a TS React client. Using Ring-Buffers and Sqlite, I've gotten it to work 'offline' smooth as butter: the goal, then, is for a
